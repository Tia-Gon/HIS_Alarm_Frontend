...
class _$_UserModel extends _UserModel {
  ...
  @override
  String toString() {
    return 'UserModel(email: $email, name: $name, emailNotification: $emailNotification, mobile: $mobile, scope: $scope, address: $address, latitude: $latitude, longitude: $longitude, profileImage: $profileImage, password: $password, googleOauth2Token: $googleOauth2Token)';
  }
